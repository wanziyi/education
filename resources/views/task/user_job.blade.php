...
<script>
    $(document).on("click","#add",function(){
        var u_id = $("input[id='u_id']").val();
        console.log(u_id);
        var cur_id = $("select[id='cur_id']").val();
        console.log(cur_id);
        var task_name = $("input[id='task_name']").val();
        console.log(task_name);
        $.ajax({
            url:"{{url('/task/jobDo')}}",
            type:'POST',
            data:{u_id:u_id,cur_id:cur_id,task_name:task_name},
            dataType:'json',
