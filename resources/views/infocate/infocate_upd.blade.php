        ...
        <div class="box-body">
            ...
            <div class="table-box">
                ...
                <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="home">
                                   <form enctype="multipart/form-data" id="fileForm">
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" name="info_name" id="info_name"   placeholder="资讯标题" value="{{$res->cate_name}}">
                                    </div>
                      ...
                      <a href="javascript:void(0);" id="btn_add_file" class="btn btn-primary" ng-click="setEditorValue();save() " ids="{{$res->cate_id}}"><i class="fa fa-save"></i>修改</a>
