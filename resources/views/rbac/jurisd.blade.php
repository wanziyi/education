                    ...
                    <div class="tab-pane active" id="home">
                        <div class="row data-type">
                            ...
                            <div class="col-md-10 data">
                                <input type="text" class="form-control"  placeholder="权限名称" name="priv_name" id="priv_name">
                            </div>
                            <div class="col-md-2 title">权限路由</div>
                            <div class="col-md-10 data">
                                <input type="text" class="form-control"  placeholder="权限路由" name="priv_url" id="priv_url">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).on("click","#add",function(){
        ...
        $.ajax({
            url:"{{url('/rbac/privDo')}}",
            type:'POST',
            data:{priv_name:priv_name,priv_url:priv_url},
            dataType:'json',
