                            ...
                            <div class="tab-pane active" id="home">
                                   <form enctype="multipart/form-data" id="fileForm">
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" name="cd_title" id="cd_title"   placeholder="资料标题" value="">
                                    </div>

                                    <div class="col-md-2 title">资料名称</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" name="cd_name" id="cd_name"   placeholder="资料名称" value="">
                                    </div>

                                    <div class="col-md-2 title editer">资料内容</div>
                                   <div class="col-md-10 data editer">
                                       <textarea name="cd_text" id="cd_text" ></textarea>
                                   </div>
                                </div>
...
<script type="text/javascript" charset="utf-8">//初始化编辑器
    ...
    $("#btn_add_file").on("click",function(){
        ...
        $.ajax({
            url:"{{url('coursedata/coursedata_add')}}",
            data:{cd_name:cd_name,cd_text:cd_text,cd_title:cd_title},
            type:"post",
