...
<div class="head" id="fixed">
	<div class="nav">
        ...
        <ul class="nag">
        	<li><a href="{{url('index/course')}}" class="link1">课程</a></li>
            <li><a href="{{url('index/article')}}" class="link1">资讯</a></li>
            <li><a href="{{url('index/teacher')}}" class="link1">讲师</a></li>
            <li><a href="{{url('index/question')}}" class="link1" target="_blank">题库</a></li>
            <li><a href="{{url('index/askarea')}}" class="link1" target="_blank">问答</a></li>
        </ul>
        ...
        <!--<span class="select">
            ...
            <a href="{{url('index/mycourse')}}"  onMouseOver="logmine()" style="width:70px" class="link2 he ico" target="_blank">sherley</a>
            <span id="lne" style="display:none" onMouseOut="logclose()" onMouseOver="logmine()">
                <span style="background:#fff;">
                	<a href="{{url('index/mycourse')}}" style="width:70px; display:block;" class="link2 he ico" target="_blank">sherley</a>
                </span>
...
<div class="td1">
	<div class="tdcont">
        ...
        <span class="tdtext">
            ...
            <p><a href="{{url('index/course')}}" class="btninto">开始学习</a></p>
        </span>
...
关知识点,文字解析与视频解析相结合。</p><br/>
			<p><a href="{{url('index/train')}}" class="btninto">点击测评</a></p>
        </span>
        <div style="clear:both"></div>
    </div>
</div>
...
点，点点精通。</p><br/>
			<p><a href="{{url('index/train')}}" class="btninto">开始练习</a></p>
        </span>
        <div style="clear:both"></div>
    </div>
</div>
...
<span class="morecourse"><a href="{{url('index/course')}}" class="btnlink">更多课程</a></span>
