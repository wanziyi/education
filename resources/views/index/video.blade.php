...
<body>
   <div class="linevideo" style="overflow-x:hidden">
    	<span class="returnindex"><a class="gray" href="{{url('index/coursefont1')}}" style="font-size:14px;">返回课程</a></span>   
			...
			<div class="tab_box tabcard">
				<div style="padding-bottom:30px;">
					<dl class="mulu noo1">
                        ...
                        <a href="{{url('index/video')}}"><dd><i class="forwa nn"></i><strong class="cataloglink">课时1：会计的概念与目标1</strong></dd></a>
				...
				<div class="hide">
                    ...
                    <div class="c_eform" style="width:280px;margin-left:10px;">
                       ...
                       <a href="{{url('index/video')}}" class="fombtn">提交</a>
                       <div class="clearh"></div>
                    </div>					
				</div>
				</div>
                <div class="hide">
                    ...
                    <div class="clearh" ></div>
                       ...
                       <a href="{{url('index/video')}}" class="fombtn" style="margin-right:30px;">发布</a>
                       <div class="clearh"></div>
                    </div>
					<ul class="evalucourse" style="width:280px;">
                    	<li>
                        	<p class="vptext"><a target="_blank" class="peptitle" href="{{url('index/video')}}">2013年国家公务员考试真题2013年国家公务员考试真题2013年国家公务员考试真题2013年?</a></p>         <p class="peptime pswer"><span style="float:left;"><b class="coclass">候候&nbsp;&nbsp;</b>发表于 2015-05-8 </span><span class="pepask" style="float:right;">回答(<strong style="color:#3eb0e0;"><a href="{{url('index/video')}}" class="bluelink" target="_blank">10</a></strong>)&nbsp;&nbsp;&nbsp;&nbsp;浏览(<strong style="color:#3eb0e0;"><a href="{{url('index/video')}}" class="bluelink" target="_blank">10</a></strong>)</span>					
                            </p>                           
                        </li>
                        <li>
                        	<p class="vptext"><a target="_blank" class="peptitle" href="{{url('index/video')}}">2013年国家公务员考试真题2013年国家公务员考试真题2013年国家公务员考试真题2013年?</a></p>         <p class="peptime pswer"><span style="float:left;"><b class="coclass">候候&nbsp;&nbsp;</b>发表于 2015-05-8 </span><span class="pepask" style="float:right;">回答(<strong style="color:#3eb0e0;"><a href="{{url('index/video')}}" class="bluelink" target="_blank">10</a></strong>)&nbsp;&nbsp;&nbsp;&nbsp;浏览(<strong style="color:#3eb0e0;"><a href="{{url('index/video')}}" class="bluelink" target="_blank">10</a></strong>)</span>					
				...
				<div class="hide">
                    <div class="c_eform veform" style="margin-top:15px;margin-left:35px;">
					   <!--四种状态-->
					   <p>此课时暂无作业</p>
					   <p>共4道作业题<a href="{{url('index/homework')}}" target="_blank"><span class="star_zy">继续做题</span></a></p>
					   <p>共4道作业题<a href="{{url('index/homework_jiexi')}}" target="_blank"><span class="star_zy">查看解析</span></a></p>
					   <p>共4道作业题<a href="{{url('index/homework')}}" target="_blank"><span class="star_zy">开始作业</span></a></p>                                 
				</div>
				</div>				
			</div>
		</div> 
