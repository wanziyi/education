			...
			<div class="tab_box">
				<div>
					...
					<div>
						...
						<div class="mulu_con">
							...
							<a href="{{url('index/video')}}"><dd><strong class="cataloglink">课时1：会计的概念与目标1</strong><i class="fini nn"></i></dd></a>
							<a href="{{url('index/video')}}"><dd><strong class="cataloglink">课时2：会计的概念与目标2</strong><i class="fini fn"></i></dd></a>
							<dd class="smalltitle"><strong>第二节&nbsp;&nbsp;会计的职能与方法</strong></dd>
							<a href="{{url('index/video')}}"><dd><strong class="cataloglink">课时1：会计的职能与方法1</strong><i class="fini nn"></i></dd></a>
							<a href="{{url('index/video')}}"><dd><strong class="cataloglink">课时2：会计的职能与方法2</strong><i class="fini fn"></i></dd></a>
							<a href="{{url('index/video')}}"><dd><strong class="cataloglink">课时1：会计的职能与方法3</strong><i class="fini ff"></i></dd></a>
						</div>
					</div>
					<div>
						...
						<div class="mulu_con">
							...
							<a href="{{url('index/video')}}"><dd><strong class="cataloglink">课时1：会计要素与会计等式1</strong><i class="fini nn"></i></dd></a>
							<a href="{{url('index/video')}}"><dd><strong class="cataloglink">课时2：会计要素与会计等式2</strong><i class="fini nn"></i></dd></a>
						</div>
					</div>
                   </dl>                   
				</div>
				<div class="hide">
                    ...
                    <div class="c_eform">                      
                       ...
                       <a href="{{url('index/coursefont')}}" class="fombtn">发布评论</a>
                       <div class="clearh"></div>
                    </div>
                ...
                <div class="hide">
                    ...
                    <div class="c_eform">
                       ...
                       <a href="{{url('index/coursefont1')}}" class="fombtn">发布</a>
                       <div class="clearh"></div>
                    </div>
					<ul class="evalucourse">
                    	<li>
                            ...
                            <span class="pepcont">
                            <p><a href="{{url('index/coursefont1')}}" class="peptitle" target="_blank">2013年国家公务员考试真题2013年国家公务员考试真题2013年国家公务员考试真题2013年?</a></p>
                            <p class="peptime pswer"><span class="pepask">回答(<strong><a class="bluelink" href="{{url('index/coursefont1')}}">10</a></strong>)&nbsp;&nbsp;&nbsp;&nbsp;浏览(<strong><a class="bluelink" href="{{url('index/coursefont1')}}">10</a></strong>)</span>2015-01-02</p>                        
                            </span>
                        </li>
                        <li>
                        	<span class="pephead"><img src="/images/0-0.JPG" width="50" title="候候">
				...
				<div class="hide">
					...
					<ul class="notelist" >
       <li>
	   <p class="mbm mem_not"><a href="{{url('index/coursefont1')}}" class="peptitle">1.rar</a></p>
       		<p class="gray"><b class="coclass">课时：<a href="{{url('index/coursefont1')}}" target="_blank">会计的概念与目标1</a></b><b class="cotime">上传时间：<b class="coclass" >2015-05-8</b></b></p>
            
       </li>  
       <li>
	   <p class="mbm mem_not"><a href="{{url('index/coursefont1')}}" class="peptitle">资料.rar</a></p>
       		<p class="gray"><b class="coclass">课时：<a href="{{url('index/coursefont1')}}" target="_blank">会计的概念与目标2</a></b><b class="cotime">上传时间：<b class="coclass" >2015-05-8</b></b></p>
...
<div class="ctext">
    ...
    <div class="teacher">
    <div class="teapic">
        <a href="{{url('index/coursefont')}}"  target="_blank"><img src="/images/c1.jpg" height="60" title="财经法规与财经职业道德"></a>
        <h3 class="courh3"><a href="{{url('index/coursefont')}}" class="peptitle" target="_blank">财经法规与财经职业道德</a></h3>
    </div>
    <div class="clearh"></div>
    <div class="teapic">
        <a href="{{url('index/coursefont')}}"  target="_blank"><img src="/images/c2.jpg" height="60" title="财经法规与财经职业道德"></a>
        <h3 class="courh3"><a href="{{url('index/coursefont')}}" class="peptitle" target="_blank">财经法规与财经职业道德</a></h3>
    </div>
    <div class="clearh"></div>
    <div class="teapic">
        <a href="{{url('index/coursefont')}}"  target="_blank"><img src="/images/c3.jpg" height="60" title="财经法规与财经职业道德"></a>
        <h3 class="courh3"><a href="{{url('index/coursefont')}}" class="peptitle" target="_blank">财经法规与财经职业道德</a></h3>
    </div>
    <div class="clearh"></div>
    </div>
