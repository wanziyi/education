			...
			<div class="tab_box">
				<div>
					<ul class="memb_course">
                        ...
                        <li>
                            <div class="courseli">
                            <a href="{{url('index/video')}}" target="_blank"><img width="230" src="/images/c8.jpg"></a>
                            <p class="memb_courname"><a href="{{url('index/video')}}" class="blacklink">会计基础</a></p>
                            <div class="mpp">
                                <div class="lv" style="width:20%;"></div>
                            </div>
                            <p class="goon"><a href="{{url('index/video')}}"><span>继续学习</span></a></p>
                            </div>
                        </li>
<li>
                            <div class="courseli">
				...
				<div class="hide">
					...
					<ul class="memb_course">
                        ...
                        <li>
                            <div class="courseli">
                            <a href="{{url('index/video')}}" target="_blank"><img width="230" src="/images/c8.jpg"></a>
                            <p class="memb_courname"><a href="{{url('index/coursecont')}}" class="blacklink">会计基础</a></p>
							<div class="mpp">
                                <div class="lv" style="width:100%;"></div>
                            </div>
                            <p class="goon"><a href="{{url('index/coursecont')}}"><span>查看课程</span></a></p>
                            </div>
                        </li>
                        <li>
                            <div class="courseli">
				...
				<div class="hide">
					...
					<ul class="memb_course">                   	
                        <li>
                            ...
                            <a href="{{url('index/video')}}" target="_blank"><img width="230" src="/images/c8.jpg" class="mm"></a>
                            <p class="memb_courname"><a href="{{url('index/video')}}" class="blacklink">会计基础</a></p>
                            <div class="mpp">
                                <div class="lv" style="width:20%;"></div>
                            </div>
