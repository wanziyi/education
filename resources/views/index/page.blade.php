...
<div class="coursecont">
    ...
    <ul class="courseul pageul">
        <li class="curr" style="border-radius:3px 3px 0 0"><a href="{{url('index/page')}}">关于我们<b></b></a></li>
        <li><a href="{{url('index/pagecontact')}}" >联系我们<b></b></a></li>
        <li><a href="{{url('index/page')}}" >帮助中心<b></b></a></li>
        <li><a href="{{url('index/page')}}" >意见反馈<b></b></a></li>
        <li style="border-radius:0 0 3px 3px "><a href="{{url('index/page')}}" >加入我们<b></b></a></li>
    </ul>
    </div>
    <div class="courseright pageright" style="min-height:500px;">
        ...
        <div class="pagetext">
            ...
            <div class="imgdiv">
                <img src="/images/tbanner1.jpg" width="740"> 
                <p>图片信息一</p>
            </div>
            <p>
            ...
            <div class="imgdiv">
                <img src="/images/tbanner2.jpg" width="740"> 
                <p>图片信息二</p>
            </div>
        </div>
    </div>
