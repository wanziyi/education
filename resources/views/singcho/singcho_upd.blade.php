...
<body>
                        ...
                        <table class="table table-bordered table-striped"  width="800px">
                            ...
                            <tr>
                                <td>单选题答案</td>
                                <td>
                                    <input  id="question_contents" value="" style="background:#acffff;border:1px solid #ffffff"><br>
                                    <input  id="question_contentss" value="" style="background:#ffffff;border:1px solid #ffffff"><br>
                                    <input  id="question_contentsss" value="" style="background:#acaaca;border:1px solid #ffffff"><br>
                                    <input  id="question_contentssss" value="" style="background:#ffffff;border:1px solid #ffffff"><br>
                                </td>
                            </tr>
                            <tr>
                                <td>正确答案</td>
                            ...
                            <tr>
                                <td>题库类型</td>
                                <td>
                                    <input type="radio"  name="question_ttype" @if($data['question_ttype']=="PHP") checked @endif value="{{$data['question_ttype']}}" id="question_ttype">PHP
                                    <input type="radio"  name="question_ttype" @if($data['question_ttype']=="JAVA") checked @endif value="{{$data['question_ttype']}}" id="question_ttype">JAVA
                                    <input type="radio"  name="question_ttype" @if($data['question_ttype']=="C++") checked @endif value="{{$data['question_ttype']}}" id="question_ttype">C++
                                    <input type="radio"  name="question_ttype" @if($data['question_ttype']=="Pythsn") checked @endif value="{{$data['question_ttype']}}" id="question_ttype">Pythsn
                                </td>
                            </tr>
...
<script>
    $(document).on("click","#upd",function(){
        ...
        $.ajax({
            ...
            data : {question_name:question_name,question_contents:question_contents,question_yescten:question_yescten,question_ttype:question_ttype,question_id:question_id,question_type:question_type,question_score:question_score,question_bian:question_bian,per_id:per_id},
            dataType : "json",
            type : "post",
